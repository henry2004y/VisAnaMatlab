...
%  a structured 3D vector data into VTK file, with name specified by the 
%  string filename. (u,v,w) are the vector components at the points 
%  (x,y,z). x,y,z should be 3-D matrices like those generated by meshgrid, 
%  where point(ijk) is specified by x(i,j,k), y(i,j,k) and z(i,j,k).
...
%  and scalar values. 
%
%  vtkwrite(filename,'structured_grid',x,y,z,'vectors',title,u,v,w,
%  'scalars',title2,r) writes a 3D structured grid that contains both 
...
%  allows user to specify origin of dataset. (default: 0, 0, 0).
%
%  vtkwrite(filename,'unstructured_grid',x,y,z,'vectors',title,u,v,w,
%  'scalars',title2,r) writes a 3D unstructured grid that contains both 
%  vector and scalar values. x,y,z,u,v,w,r must all be the same size and 
%  contain the corresponding positon, vector and scalar values.
%  
