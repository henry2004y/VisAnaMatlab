% Draw z=0 cuts for G8 and G28 flybys from GM 2D outputs.
%
...
switch flyby
   case 'G8'
      disp('G8 flyby')
      filename = '~/Ganymede/MOP2018/runG8_PIC_1200s/GM/z=0_var_3_t00001952_n00719797.out'; % 2d GM outputs
      plotrange = [-3 3 -3 3];
   case 'G28'
      disp('G28 flyby')
...
plot_data(data,filehead,'ux ux;uy','plotrange',plotrange,...
