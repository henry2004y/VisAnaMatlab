...
Region = cell(4,1);
Region{1} = [-2.04 -2.01 -0.15 0.15 0.03 0.14];
Region{2} = [-1.81 -1.75 -0.2 0.2 0.03 0.14];
Region{3} = [-1.94 -1.88 -0.2 0.2 -0.14 -0.04];
Region{4} = [-1.92 -1.86 -0.2 0.2 0.2 0.3];

% Region{1} = [-1.87 -1.86 -0.2 0.2 0.02 0.10];
% Region{2} = [-1.875 -1.87 -0.2 0.2 0.02 0.10];
% Region{3} = [-1.905 -1.875 -0.2 0.2 0.02 0.10];
% Region{4} = [-1.92 -1.91 -0.2 0.2 0.02 0.10];
