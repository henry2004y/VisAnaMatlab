...
filename = '~/Ganymede/newPIC/run_G8_newPIC/box_FTE_G8_1200s.outs'; % 3d PC outputs
[filehead,data] = read_data(filename,'verbose',false);
...
[sx,sy,sz] = meshgrid(-1.75:0.125:-1.6,-1.6:.5:1.6,1.);
